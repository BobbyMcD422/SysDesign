...
type BulkClassUploadFormProps = {
  onCreated: (classes: ClassRecord[]) => void;
  onClose: () => void;
};
...
export function BulkClassUploadForm({
  onCreated,
  onClose,
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/api/classes/bulk-upload`, {
        method: "POST",
        credentials: "include",
        body: formData,
      });
